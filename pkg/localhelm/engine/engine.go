...
func (e Engine) Render(chrt *chart.Chart, values util.Values) (map[string]string, error) {
...
func Render(chrt *chart.Chart, values util.Values) (map[string]string, error) {
...
func RenderWithClient(chrt *chart.Chart, values util.Values, config *rest.Config) (map[string]string, error) {
	return Engine{
...
func (e Engine) initFunMap(t *template.Template, referenceTpls map[string]renderable) {
	...
	funcMap["tpl"] = func(tpl string, vals util.Values) (string, error) {
...
func (e Engine) renderWithReferences(tpls, referenceTpls map[string]renderable) (rendered map[string]string, err error) {
	...
	for _, filename := range keys {
		...
		vals["Template"] = util.Values{"Name": filename, "BasePath": tpls[filename].basePath}
		var buf strings.Builder
...
func allTemplates(c *chart.Chart, vals util.Values) map[string]renderable {
...
// scope.
func recAllTpls(c *chart.Chart, templates map[string]renderable, vals util.Values) {
